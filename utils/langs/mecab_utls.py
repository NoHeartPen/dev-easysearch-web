...
def _convert_full_text_by_mecab(tagger: MeCab, input_text: str) -> list[str]:
    ...
    try:
        ...
        for parsed_result in parsed_all_result[0:-1]:
            ...
            if "数詞" in jishokei_parsed_result or "助詞-" in jishokei_parsed_result or "助動詞-" in jishokei_parsed_result or "接続詞-" in jishokei_parsed_result or "記号-" in jishokei_parsed_result:
                continue
